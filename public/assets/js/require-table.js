    ...
    var Table = {
        ...
        api: {
            ...
            formatter: {
                ...
                limg:  function (value, row, index) {
                    return '<a href="'+Fast.api.cdnurl(value)+'" target="_blank"><img src="'+Fast.api.cdnurl(value)+'" style="height:60px;width:150px"></a>'
                },
                lstatus:function(value, row, index){
